...
tnoremap <unique> <silent> <M-[> <C-\><C-N>
tnoremap <unique> <silent> <M-]> <C-\><C-N>
tnoremap <unique> <silent> <expr> <M-r> '<C-\><C-N>"'.nr2char(getchar()).'pi'
